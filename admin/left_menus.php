<div class="col-md-3">
	<div class="list-group">
		...
		<a href="posts.php" class="list-group-item active "><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span> Posts<span class="badge"><?php echo $post->totalPost(); ?></span></a>
